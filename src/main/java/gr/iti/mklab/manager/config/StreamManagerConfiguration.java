...
public class StreamManagerConfiguration extends Configuration {
	...
	public static StreamManagerConfiguration readFromFile(File file) 
	...
	private static class ParseHandler extends DefaultHandler {
		...
		private StreamManagerConfiguration config = new StreamManagerConfiguration();
		...
		public StreamManagerConfiguration getConfig() {
			return config;
		}
